    ...
    <div class="flex h-screen">
        <aside class="w-64 bg-blue-800 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('admin.catches.index') }}" 
                class="flex items-center px-4 py-3 rounded-lg hover:bg-blue-700 transition
                        {{ request()->routeIs('admin.catches.*') ? 'bg-blue-700' : '' }}">
...
Setelah 2 file dibuat, **refresh** halaman test:
```
http://localhost:8000/test-admin-files